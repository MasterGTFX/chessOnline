...
class Board:
    ...
    def __init__(self, screen, board_size, field_board_size):
        ...
        self.black_queen = pygame.image.load(os.path.join("resources", "black_queen.png"))
        self.white_queen = pygame.image.load(os.path.join("resources", "white_queen.png"))
        self.black_pawn = pygame.image.load(os.path.join("resources", "black_pawn.png"))
        self.white_pawn = pygame.image.load(os.path.join("resources", "white_pawn.png"))
        self.white_king = pygame.image.load(os.path.join("resources", "white_king.png"))
        self.black_king = pygame.image.load(os.path.join("resources", "black_king.png"))
        self.white_rook = pygame.image.load(os.path.join("resources", "white_rook.png"))
        self.black_rook = pygame.image.load(os.path.join("resources", "black_rook.png"))
        self.white_bishop = pygame.image.load(os.path.join("resources", "white_bishop.png"))
        self.black_bishop = pygame.image.load(os.path.join("resources", "black_bishop.png"))
        self.white_knight = pygame.image.load(os.path.join("resources", "white_knight.png"))
        self.black_knight = pygame.image.load(os.path.join("resources", "black_knight.png"))
    ...
    def move_piece(self, field):
        if not field == self.field_selected:
